...
const initialLeads: Lead[] = [
  // --- The Yorkville Luxury Group (GTA) Prospects ---
  {
    ...
    search_criteria: '3 Bed Penthouse in Yorkville with private elevator & 800 sq ft terrace',
    notes: 'Pre-approved with TD Private Banking. TRESA Information Before Representation (IBR) disclosure issued automatically via SMS before intent capture.',
  ...
  },
  {
    ...
    search_criteria: 'Modern 3 Bed Luxury Suite in Forest Hill or Midtown',
    notes: 'TRESA Information Before Representation (IBR) disclosure issued automatically via SMS before intent capture. Low maintenance fees and private EV charger requested.',
  ...
  },
  {
    ...
    notes: 'Cash buyer relocating from Montreal. Unrepresented status verified via TRESA disclosure. TRESA Information Before Representation (IBR) disclosure issued automatically via SMS before intent capture.',
    tags: ['Bridle_Path_Estate', 'Cash_Buyer', 'ISA_Qualified'],
    channel: 'Luxury Web Widget',
  ...
  },
  {
    ...
    notes: 'Inbound listing inquiry. Automated speed-to-lead SMS outreach dispatched. TRESA Information Before Representation (IBR) disclosure issued automatically via SMS before intent capture.',
  ...
  },
  {
    ...
    pre_approved: true,
    representation_status: 'Needs_Verification',
    search_criteria: 'Four Seasons Residences Yorkville high-floor 3 Bed suite',
    notes: 'BRA Representation Status: Ambiguous (Prospect mentioned signing open house guest sheet). Escalated to human agent. TRESA Information Before Representation (IBR) disclosure issued automatically via SMS before intent capture.',
  ...
  },
  {
    ...
    search_criteria: 'Yorkville 2 Bed Sub-Penthouse',
    notes: 'Prospect confirmed signing a Buyer Representation Agreement (BRA) with Chestnut Park last week. SRP / Disqualified per TRESA rules.',
  ...
  },
  {
    ...
    notes: 'UHN Surgeon. Seeking quiet cul-de-sac location in top school catchment. TRESA Information Before Representation (IBR) disclosure issued automatically via SMS before intent capture.',
  ...
  },
  {
    ...
    pre_approved: true,
    representation_status: 'Represented_By_Other',
    search_criteria: 'Sub-Penthouse on Cumberland St in Yorkville',
    notes: 'Currently represented under contract with Sotheby’s International Realty. SRP / Disqualified per TRESA rules.',
