...
export const LeadDetailModal: React.FC<LeadDetailModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fadeIn font-sans">
      <div className="bg-[#141414] border border-[#C5A059]/40 rounded-2xl w-full max-w-3xl max-h-[90vh] overflow-hidden shadow-2xl flex flex-col">
        {/* Header */}
        <div className="p-5 border-b border-[#262626] bg-[#0A0A0A] flex items-center justify-between shrink-0">
          <div className="flex items-center space-x-3">
            <div className={`w-10 h-10 rounded-xl flex items-center justify-center font-bold text-sm shrink-0 ${
              isQualified ? 'bg-[#10B981]/15 text-[#10B981] border border-[#10B981]/30' :
              isEscalated ? 'bg-amber-500/15 text-amber-400 border border-amber-500/40' :
            ...
            <div>
              <div className="flex items-center space-x-2">
                ...
                <span className={`text-[10px] px-2 py-0.5 rounded font-bold border uppercase tracking-wider ${
                  isQualified ? 'bg-[#10B981]/15 text-[#10B981] border-[#10B981]/30' :
          ...
          <button
            onClick={onClose}
            className="p-1.5 rounded-lg text-[#CBD5E1] hover:text-white hover:bg-[#262626] transition-colors cursor-pointer"
          >
            <X className="h-5 w-5" />
          </button>
        </div>
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1 scrollbar-thin">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <div className="p-3 bg-[#0A0A0A] rounded-xl border border-[#262626] space-y-1">
          ...
          <div className="p-4 bg-[#0A0A0A] rounded-xl border border-[#262626] space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-xs">
              <div className="p-2.5 bg-[#141414] rounded-lg border border-[#262626] flex items-center justify-between">
          ...
          {onResolveEscalation && (
            <div className="p-4 bg-[#0A0A0A] rounded-xl border border-[#C5A059]/40 space-y-3">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full bg-[#141414] border border-[#262626] focus:border-[#E5C178] rounded-lg px-3 py-2 text-xs text-white placeholder-[#64748B] focus:outline-none"
                />
              </div>
              ...
              <div className="flex flex-wrap items-center gap-2 pt-1">
                <button
                  ...
                  className="btn-executive-primary px-3.5 py-2 rounded-lg text-xs font-bold flex items-center space-x-1.5 cursor-pointer disabled:opacity-50"
                >
                ...
                <button
                  ...
                  disabled={isSubmitting}
                  className="bg-[#262626] hover:bg-[#333] text-white px-3.5 py-2 rounded-lg text-xs font-bold border border-[#333] transition-colors cursor-pointer disabled:opacity-50"
                >
                ...
                <button
                  ...
                  disabled={isSubmitting}
                  className="bg-rose-950/80 hover:bg-rose-900 text-rose-300 px-3.5 py-2 rounded-lg text-xs font-bold border border-rose-800 transition-colors cursor-pointer disabled:opacity-50"
                >
        ...
        <div className="p-4 border-t border-[#262626] bg-[#0A0A0A] flex items-center justify-between shrink-0">
          ...
          <button
            onClick={onClose}
            className="bg-[#262626] hover:bg-[#333] text-white text-xs px-4 py-2 rounded-lg font-semibold transition-colors cursor-pointer"
          >
            Close
          </button>
        </div>
